...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold cursor-pointer transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-icon-accent/50 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        primary:
          'bg-gradient-to-r from-icon-accent to-accent-orange text-white hover:shadow-lg hover:shadow-icon-accent/25',
        destructive:
          'bg-red-500 text-white hover:bg-red-600',
        outline:
          'border-2 border-icon-accent/30 bg-transparent hover:bg-icon-accent/5 hover:border-icon-accent/50',
        secondary:
          'bg-secondary text-foreground hover:bg-secondary/80 border border-icon-accent/10',
        ghost:
