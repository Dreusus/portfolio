  ...
  return (
    <div className='md:hidden'>
      <button
        ...
        className='p-2 rounded-lg hover:bg-accent-warm transition-colors'
        ...
        {isOpen && (
          <>
            ...
            <motion.nav
              ...
              className='fixed top-0 right-0 h-full w-[280px] bg-background z-50 shadow-xl border-l border-border'
            >
              ...
              <div className='flex flex-col gap-1 px-4'>
                {NAV_ITEMS.map((item) => (
                  <Link
                    ...
                    href={`#${item.link}`}
                    onClick={closeMenu}
                    className='py-3 px-4 text-sm font-medium rounded-lg hover:bg-accent-warm transition-colors'
                  >
                    {t.nav[item.key]}
                  </Link>
                ))}
