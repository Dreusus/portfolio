export const ru = {
    ...
    hero: {
        ...
        subtitle: 'Создаю надёжные автотесты и обеспечиваю качество продукта',
        roles: [
            'Архитектор тестов',
            'Страж качества',
            'Охотник за багами',
    ...
    footer: {
        ...
        description: 'Full Stack QA Инженер, создающий надёжные автотесты и обеспечивающий качество продукта.',
        quickLinks: 'Навигация',
        contact: 'Контакты',
        backToTop: 'Наверх',
        madeWith: 'Сделано с',
        using: 'на Next.js & Tailwind CSS',
    },
